...
class GBProof
{
 ...
 public:
   ...
   * Reduction and computation of SPolynomials
   */  
...
private:
  ...
  /**
   * The sequence of polynomials in GBasis used in the reduction during independent membership proof production.  
   */
  std::vector<std::string> d_membershipSeq{};

  /**
   * Hooks for: 
   * Gbasis Proof Production: sPoly, reductionStart, reductionStep, reductionEnd
   * Arbitrary Poly Proof Production: membershipStart, membershipStep and membershipEnd. 
   */
  ...
  /**
   * A representation of the Ideal that we are currently proving membership facts from
