 ...
 */
  std::vector<CoCoA::RingElem> findZero(const CoCoA::ideal& ideal, std::shared_ptr<IdealProof> initialIdealProof, NodeManager *nm, CDProof* globalTheoryProofs);
...
std::unique_ptr<ListEnumerator> factorEnumerator(CoCoA::RingElem univariatePoly,
                                                 std::shared_ptr<IdealProof> idealProof);
