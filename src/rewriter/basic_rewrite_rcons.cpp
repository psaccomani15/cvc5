                                                    ...
                                                    const Node& eq)
{
  ...
  bool isFf = eq[0][0].getType().isFiniteField();
  ProofRule rule = isFf   ? ProofRule::FF_POLY_NORM
                   : isBv ? ProofRule::BV_POLY_NORM
  ...
  ProofRule rrule = isFf   ? ProofRule::FF_POLY_NORM_EQ
                    : isBv ? ProofRule::BV_POLY_NORM_EQ
