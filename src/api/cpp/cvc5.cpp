...
const static std::unordered_map<Kind, std::pair<internal::Kind, std::string>>
  ...
  KIND_ENUM(Kind::INTERNAL_KIND, internal::Kind::UNDEFINED_KIND),
      ...
      KIND_ENUM(Kind::FINITE_FIELD_IDEAL, internal::Kind::FINITE_FIELD_IDEAL),
      KIND_ENUM(Kind::FINITE_FIELD_VARIETY, internal::Kind::FINITE_FIELD_VARIETY),
        /* FP --------------------------------------------------------------- */
        KIND_ENUM(Kind::CONST_FLOATINGPOINT, internal::Kind::CONST_FLOATINGPOINT),
...
const static std::unordered_map<internal::Kind,
  ...
  {internal::Kind::UNDEFINED_KIND, Kind::UNDEFINED_KIND},
      ...
      {internal::Kind::NOT, Kind::NOT}, {internal::Kind::AND, Kind::AND},
      {internal::Kind::IMPLIES, Kind::IMPLIES}, {internal::Kind::OR, Kind::OR},
      {internal::Kind::XOR, Kind::XOR}, {internal::Kind::ITE, Kind::ITE},
      /* UF -------------------------------------------------------------- */
      ...
      /* Arithmetic ------------------------------------------------------ */
      {internal::Kind::ADD, Kind::ADD}, {internal::Kind::MULT, Kind::MULT},
      {internal::Kind::NONLINEAR_MULT, Kind::MULT},
      {internal::Kind::IAND, Kind::IAND}, {internal::Kind::PIAND, Kind::PIAND},
      {internal::Kind::POW2, Kind::POW2},
      {internal::Kind::INTS_LOG2, Kind::LOG2}, {internal::Kind::SUB, Kind::SUB},
      ...
      {internal::Kind::LT, Kind::LT}, {internal::Kind::LEQ, Kind::LEQ},
      {internal::Kind::GT, Kind::GT}, {internal::Kind::GEQ, Kind::GEQ},
      {internal::Kind::IS_INTEGER, Kind::IS_INTEGER},
      {internal::Kind::TO_INTEGER, Kind::TO_INTEGER},
      {internal::Kind::TO_REAL, Kind::TO_REAL}, {internal::Kind::PI, Kind::PI},
      ...
      {internal::Kind::BITVECTOR_ROTATE_RIGHT_OP, Kind::BITVECTOR_ROTATE_RIGHT},
      ...
      {internal::Kind::FINITE_FIELD_IDEAL, Kind::FINITE_FIELD_IDEAL},
      {internal::Kind::FINITE_FIELD_VARIETY, Kind::FINITE_FIELD_VARIETY},
        /* FP -------------------------------------------------------------- */
